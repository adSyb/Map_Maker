...
function drawToCanvas(){
	...
	var data = document.getElementById("map1").innerHTML;
...
var svgStyle = 'path, line {fill: none; stroke: black; stroke-linecap: round;} ' + 
'.field {stroke: none; fill-opacity: 1.0;} .slope {stroke-width: 1;} .river {stroke-width: 2; stroke: black;}' +
'.coast {stroke-width: 4;} .border {stroke-width: 5; stroke-dasharray: 4,4; stroke-linecap: butt;} ' +
'text {font-family: "Palatino Linotype", "Book Antiqua", Palatino, serif; color: black; stroke: white; ' +
'stroke-width: 5; stroke-linejoin: round; paint-order: stroke;} text.region {stroke-width:10; font-variant: small-caps;} ' +
'svg {background-color: white;}'

window.onload = function() {
	var mapsvg = d3.select("#map1")
		.append("svg").attr("xmlns", "http://www.w3.org/2000/svg")
		.attr("width", 800)
		.attr("height", 800);
	
	mapsvg.append('style').text(svgStyle);
		

	doMap(mapsvg,defaultParams);
	drawToCanvas();
